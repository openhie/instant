...
```sh
yarn instant init <your_package_name>
```
...
```sh
./deploy init -t docker core covid19surveillance -c="../who-covid19-surveillance-package"
```
...
```sh
./deploy init -t k8s core covid19surveillance -c="../who-covid19-surveillance-package"
```

> The covid19surveillance package is available [here](https://github.com/jembi/who-covid19-surveillance-package)
