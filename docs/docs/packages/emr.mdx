...
the OpenMRS system on a pc/laptop for demonstration and assessment purposes. This means that the implementar does not 
have to install multiple dependancies manually (mysql db, web servers, config etc)
but instead have functional application running instantly.
