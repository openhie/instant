...
Once the download is complete, move it somewhere memorable. From there you may execute it and you will be presented with a command-line interface. E.g.:
...
To start all the default the Instant OpenHIE packages, select a deployment platform below. Have a look at the existing packages on the sidebar to see what packages are currently available.
